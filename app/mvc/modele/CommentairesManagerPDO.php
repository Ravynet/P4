...
class CommentairesManagerPDO extends Manager
{
    ...
    public function getBilletsWithComSignale () {
    ...
    public function addComment(Commentaire $commentaire){
        ...
        $q->bindValue(':id_billet', $commentaire->getBilId());
    ...
    public function signaler($commentaire) {
    ...
    public function modererCom(Commentaire $commentaire) {
